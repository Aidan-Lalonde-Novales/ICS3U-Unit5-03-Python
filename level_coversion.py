...
# Created May 2022
# This program converts a level to it's corresponding percentage.
...
def main():
    ...
    # input
    level = input("Enter a level to see it’s corresponding percentage: ")
    ...
    if percentage == -1:
        ...
        print("\nLevel {0} corresponds to {1}%.".format(level, percentage))
